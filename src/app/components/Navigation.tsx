          ...
          <div className="relative flex justify-between items-center px-6 py-4">
            ...
            <Link href="/" className="group flex items-center space-x-3 text-2xl font-bold text-white hover:text-chiliz-primary transition-all duration-300">
              <div className="relative">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-chiliz-primary to-red-600 flex items-center justify-center shadow-lg shadow-chiliz-primary/25 group-hover:shadow-chiliz-primary/40 transition-all duration-300 group-hover:scale-110">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-medium text-chiliz-primary/80 tracking-wider uppercase">
                  AI Explorer
                </span>
              </div>
            </Link>
